const list = {
    ...
    items : {
        ...
        "C의 사무실": ["볼펜꽂이", "클립 파일", "달력", "서적", "액자", "노트북", "금고", "액자", "마우스", "마우스패드", "금고 속 무언가"],
        "사건 현장": ["시신의 팔", "시신의 손", "시신의 머리", "시신의 시반", "현장의 바닥", "칼", "서적", "문 손잡이", "졸업증", "열쇠", "핸드폰"]
    },
    methods : [
    ...
    results : [
        {
            ...
            result: {
                type: "no-code",
                text: "손톱에 빨간 실이 있고<br>손목에 결박흔이 있다.",
            }
        }, {
            place: "사건 현장", 
            item: "시신의 머리",
            ...
            result: {
                type: "code",
                code: "9613",
                text: "안쪽 손잡이에서<br>왼쪽의 한 지문과<br>바깥쪽 손잡이에서<br>오른쪽의 두 종류의 지문이<br>발견됐다.",
                image: "BABfinger.png"
            }
        }, {
            place: "사건 현장",
